		...
		$.ajax({
			...
			success:function(user){
				if(user.userId==null || user.userId==""){
					...
					$("#checkLogin").text("아이디와 연락처가 일치하는 정보가 없습니다.");
					$("#checkLogin").css("color","red");
				}
			}
		});
...
<body>
	<div class="container">
		...
		<div align="center">
			...
			<a href="findId1" id="dk" type="button" class="btn btn-dark">Find ID</a>
		</div>
		<br>
		<div class="row">
			<div class="col-md-6 col-md-offset-3 text-center">
				...
				<br><br>
				<form>
					<input id="userId" type="text" placeholder="아이디 입력" maxlength="15" autocomplete="off" onkeyup="this.value=this.value.replace(/[^a-zA-Z0-9]/g,'');" required/><br>
					...
					<br><br> 
					<a id="okBtn2" type="submit" class="btn btn-default">확인</a>&emsp;&emsp;&emsp;
