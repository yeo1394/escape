	...
	<div class="container" id="loginDiv">
		<div class="row">
				<div class="col-md-6 col-md-offset-3 text-center">
					...
					<br>
					<a href="../userMain" class="btn btn-default">확인</a>
				</div>
		</div>
	</div>
</body>
...
<div class="container"  id="footnav">
	...
	<a id="b2" type="button" class="btn btn-default" href="05.html"><span class="glyphicon glyphicon-asterisk"><br>계정관리</span></a>
</div>
